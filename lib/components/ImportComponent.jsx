...
import { DropZoneItem, Loader, Box, Button, DropZone, } from '@adminjs/design-system';
const ImportComponent = ({ resource }) => {
    ...
    return (<Box margin="auto" maxWidth={600} display="flex" justifyContent="center" flexDirection="column">
